...
class _WithdrawlDepositFundsScreenState
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  '3. You will receive a transaction code to complete your deposit\n'
                  '4. Use this code in-game to finalize your transaction',
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed:
                  _isLoading
                      ? null
                      : () => _handleDeposit(_depositAmountController.text),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  '3. You will receive a transaction code\n'
                  '4. Use this code in-game to collect your money',
                  style: TextStyle(color: Colors.grey[700], fontSize: 14),
                ),
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Available: ${currencyFormat.format(_userBalance ?? 0)}',
                  style: TextStyle(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed:
                  _isLoading
                      ? null
                      : () => _handleWithdraw(_withdrawAmountController.text),
  ...
  Future<void> _handleDeposit(String amountText) async {
    // Input validation
        ...
        await showDialog<bool>(
          ...
          builder:
              (context) => AlertDialog(
                ...
                content: Text(
                  'Are you sure you want to deposit ${currencyFormat.format(amount)}?',
                ),
                actions: [
                  TextButton(
    ...
    try {
      final result = await depositFunds(amount);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Deposit successful! Save the transaction code.'),
  ...
  Future<void> _handleWithdraw(String amountText) async {
    // Input validation
    if (amountText.isEmpty) {
      ScaffoldMessenger.of(
        context,
    ...
    try {
      final result = await withdrawFunds(amount);
      final newBalance = await getUserBalance();
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            'Withdrawal successful! Save the transaction code.',
          ),
          backgroundColor: Colors.green,
          action: SnackBarAction(
            label: 'Copy Code',
  ...
  Future<double> getUserBalance() async {
    final balance = await SupabaseHelper.getUserBalance();
    return balance;
  }

  Future<String> depositFunds(double amount) async {
    final response = await SupabaseHelper.depositFunds(amount);
    return response;
  }

  Future<String> withdrawFunds(double amount) async {
    final response = await SupabaseHelper.withdrawFunds(amount);
    return response;
  }

  Future<void> transferFunds(int recipientId, double amount) async {
    final response = await SupabaseHelper.transferMoney(recipientId, amount);
    if (response) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
  ...
  Future<List<Player>> getAllPlayers() async {
    final players = await SupabaseHelper.getAllPlayers();
    return players;
  }
}
