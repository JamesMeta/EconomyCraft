...
class Linegraph1Widget extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
      ...
      primaryXAxis: DateTimeAxis(title: AxisTitle(text: xAxisLabel ?? 'Time')),
      primaryYAxis: NumericAxis(title: AxisTitle(text: yAxisLabel ?? 'Price')),
